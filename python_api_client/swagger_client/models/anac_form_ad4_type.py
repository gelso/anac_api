...
class AnacFormAD4Type(AnacFormBaseType):
    ...
    """
    swagger_types = {
        'appalto': 'AppaltoAD4Type',
        'aggiudicazioni': 'list[AggiudicazioneAD4Type]'
    }
    ...
    def __init__(self, appalto=None, aggiudicazioni=None, *args, **kwargs):  # noqa: E501
        """AnacFormAD4Type - a model defined in Swagger"""  # noqa: E501
        self._appalto = None
    ...
    @property
    def appalto(self):
        """Gets the appalto of this AnacFormAD4Type.  # noqa: E501


        :return: The appalto of this AnacFormAD4Type.  # noqa: E501
        :rtype: AppaltoAD4Type
        """
        return self._appalto

    @appalto.setter
    def appalto(self, appalto):
        """Sets the appalto of this AnacFormAD4Type.


        :param appalto: The appalto of this AnacFormAD4Type.  # noqa: E501
        :type: AppaltoAD4Type
        """
        if appalto is None:
    ...
    def aggiudicazioni(self):
        """Gets the aggiudicazioni of this AnacFormAD4Type.  # noqa: E501

        Dati relativi alle aggiudicazioni  # noqa: E501

        :return: The aggiudicazioni of this AnacFormAD4Type.  # noqa: E501
        :rtype: list[AggiudicazioneAD4Type]
        """
        return self._aggiudicazioni

    @aggiudicazioni.setter
    def aggiudicazioni(self, aggiudicazioni):
        """Sets the aggiudicazioni of this AnacFormAD4Type.

        Dati relativi alle aggiudicazioni  # noqa: E501

        :param aggiudicazioni: The aggiudicazioni of this AnacFormAD4Type.  # noqa: E501
        :type: list[AggiudicazioneAD4Type]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnacFormAD4Type, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnacFormAD4Type):
            return False
