...
class AnacFormA36Type(AnacFormBaseType):
    ...
    """
    swagger_types = {
        'appalto': 'AppaltoA36Type',
        'aggiudicazioni': 'list[AggiudicazioneA36Type]'
    }
    ...
    def __init__(self, appalto=None, aggiudicazioni=None, *args, **kwargs):  # noqa: E501
        """AnacFormA36Type - a model defined in Swagger"""  # noqa: E501
        self._appalto = None
    ...
    @property
    def appalto(self):
        """Gets the appalto of this AnacFormA36Type.  # noqa: E501


        :return: The appalto of this AnacFormA36Type.  # noqa: E501
        :rtype: AppaltoA36Type
        """
        return self._appalto

    @appalto.setter
    def appalto(self, appalto):
        """Sets the appalto of this AnacFormA36Type.


        :param appalto: The appalto of this AnacFormA36Type.  # noqa: E501
        :type: AppaltoA36Type
        """
        if appalto is None:
    ...
    def aggiudicazioni(self):
        """Gets the aggiudicazioni of this AnacFormA36Type.  # noqa: E501

        Dati relativi alle aggiudicazioni  # noqa: E501

        :return: The aggiudicazioni of this AnacFormA36Type.  # noqa: E501
        :rtype: list[AggiudicazioneA36Type]
        """
        return self._aggiudicazioni

    @aggiudicazioni.setter
    def aggiudicazioni(self, aggiudicazioni):
        """Sets the aggiudicazioni of this AnacFormA36Type.

        Dati relativi alle aggiudicazioni  # noqa: E501

        :param aggiudicazioni: The aggiudicazioni of this AnacFormA36Type.  # noqa: E501
        :type: list[AggiudicazioneA36Type]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnacFormA36Type, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnacFormA36Type):
            return False
