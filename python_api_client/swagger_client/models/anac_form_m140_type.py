...
class AnacFormM140Type(object):
    ...
    swagger_types = {
        'id_contratto': 'str',
        'modifica_contrattuale': 'ModificaContrattuale40Type'
    }
    ...
    def __init__(self, id_contratto=None, modifica_contrattuale=None):  # noqa: E501
        """AnacFormM140Type - a model defined in Swagger"""  # noqa: E501
    ...
    def id_contratto(self):
        """Gets the id_contratto of this AnacFormM140Type.  # noqa: E501

        identificativo del contratto restituito in response alla scheda di Sottoscrizione del contratto.  # noqa: E501

        :return: The id_contratto of this AnacFormM140Type.  # noqa: E501
        :rtype: str
        """
    ...
    def id_contratto(self, id_contratto):
        """Sets the id_contratto of this AnacFormM140Type.

        identificativo del contratto restituito in response alla scheda di Sottoscrizione del contratto.  # noqa: E501

        :param id_contratto: The id_contratto of this AnacFormM140Type.  # noqa: E501
        :type: str
        """
    ...
    def modifica_contrattuale(self):
        """Gets the modifica_contrattuale of this AnacFormM140Type.  # noqa: E501


        :return: The modifica_contrattuale of this AnacFormM140Type.  # noqa: E501
        :rtype: ModificaContrattuale40Type
        """
        return self._modifica_contrattuale

    @modifica_contrattuale.setter
    def modifica_contrattuale(self, modifica_contrattuale):
        """Sets the modifica_contrattuale of this AnacFormM140Type.


        :param modifica_contrattuale: The modifica_contrattuale of this AnacFormM140Type.  # noqa: E501
        :type: ModificaContrattuale40Type
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnacFormM140Type, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnacFormM140Type):
            return False
