...
class ModificaSchedaResponse(BaseResponse):
    ...
    def __init__(self, id_scheda=None, *args, **kwargs):  # noqa: E501
        """ModificaSchedaResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id_scheda(self):
        """Gets the id_scheda of this ModificaSchedaResponse.  # noqa: E501

        Identificativo univoco della scheda definito da ANAC. (A UUID specified by RFC4122)  # noqa: E501

        :return: The id_scheda of this ModificaSchedaResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def id_scheda(self, id_scheda):
        """Sets the id_scheda of this ModificaSchedaResponse.

        Identificativo univoco della scheda definito da ANAC. (A UUID specified by RFC4122)  # noqa: E501

        :param id_scheda: The id_scheda of this ModificaSchedaResponse.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModificaSchedaResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModificaSchedaResponse):
            return False
