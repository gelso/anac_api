...
class AnacFormM1Type(object):
    ...
    swagger_types = {
        'id_contratto': 'str',
        'modifica_contrattuale': 'ModificaContrattualeType'
    }
    ...
    def __init__(self, id_contratto=None, modifica_contrattuale=None):  # noqa: E501
        """AnacFormM1Type - a model defined in Swagger"""  # noqa: E501
    ...
    def id_contratto(self):
        """Gets the id_contratto of this AnacFormM1Type.  # noqa: E501

        identificativo del contratto restituito in response alla scheda di Sottoscrizione del contratto.  # noqa: E501

        :return: The id_contratto of this AnacFormM1Type.  # noqa: E501
        :rtype: str
        """
    ...
    def id_contratto(self, id_contratto):
        """Sets the id_contratto of this AnacFormM1Type.

        identificativo del contratto restituito in response alla scheda di Sottoscrizione del contratto.  # noqa: E501

        :param id_contratto: The id_contratto of this AnacFormM1Type.  # noqa: E501
        :type: str
        """
    ...
    def modifica_contrattuale(self):
        """Gets the modifica_contrattuale of this AnacFormM1Type.  # noqa: E501


        :return: The modifica_contrattuale of this AnacFormM1Type.  # noqa: E501
        :rtype: ModificaContrattualeType
        """
        return self._modifica_contrattuale

    @modifica_contrattuale.setter
    def modifica_contrattuale(self, modifica_contrattuale):
        """Sets the modifica_contrattuale of this AnacFormM1Type.


        :param modifica_contrattuale: The modifica_contrattuale of this AnacFormM1Type.  # noqa: E501
        :type: ModificaContrattualeType
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnacFormM1Type, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnacFormM1Type):
            return False
